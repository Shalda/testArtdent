<?php 
	...
	<!-- Content -->
	<div class="vu_content vu_search-page vu_posts-page col-xs-12<?php echo (dentalpress_get_option('navigation-position', 'sidebar') == 'sidebar' || $has_sidebar == true) ? ' col-md-9' : ''; ?>" role="main">
		<?php if ( have_posts() ) :  ?>
