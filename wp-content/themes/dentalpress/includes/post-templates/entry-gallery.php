<article id="post-<?php the_ID(); ?>" <?php post_class('vu_blog-post vu_bp-type-gallery'); ?> itemscope="itemscope" itemtype="https://schema.org/BlogPosting">
	...
	<?php if( !empty($dentalpress_post_format_settings['gallery']['images']) ) : ?>
		<div class="vu_bp-image">
			<?php 
				$shortcode_atts = array(
					"images" => $dentalpress_post_format_settings['gallery']['images'],
					"ratio" => "2:1",
					"lightbox" => "1",
					"navigation" => "hover",
					"pagination" => "none",
				...
				echo do_shortcode( dentalpress_generate_shortcode('vu_image_slider', $shortcode_atts) );
			?>
			...
			<div class="vu_bp-meta">
				...
				<?php if( dentalpress_get_option('blog-show-author') ) : ?>
					<span class="vu_bp-m-item vu_bp-author">
						...
						<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="<?php esc_html_e('Posts by', 'dentalpress'); ?> <?php the_author(); ?>" rel="author"><span itemprop="author"><?php the_author(); ?></span></a>
					</span>
				<?php endif; ?>
