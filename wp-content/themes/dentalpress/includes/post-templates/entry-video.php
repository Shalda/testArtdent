<article id="post-<?php the_ID(); ?>" <?php post_class('vu_blog-post vu_bp-type-video'); ?> itemscope="itemscope" itemtype="https://schema.org/BlogPosting">
	...
	<?php if ( !empty($dentalpress_post_format_settings['video']['embed-code']) ) : ?>
		<div class="vu_bp-image">
			<?php 
				$shortcode_atts = array(
					"src" => esc_attr($dentalpress_post_format_settings['video']['embed-code'])
				);

				echo do_shortcode( dentalpress_generate_shortcode('vu_embed', $shortcode_atts) );
			?>
	...
	<?php elseif ( !empty($dentalpress_post_format_settings['video']['m4v']) or !empty($dentalpress_post_format_settings['video']['ogg']) ) : ?>
		<div class="vu_bp-image">
			<div class="embed-responsive embed-responsive-2by1">
				<video class="embed-responsive-item" controls poster="<?php echo esc_url($dentalpress_post_format_settings['video']['poster']); ?>">
					<?php if ( !empty($dentalpress_post_format_settings['video']['m4v']) ) : ?>
						<source src="<?php echo esc_url($dentalpress_post_format_settings['video']['m4v']); ?>" type="video/mp4">
					<?php endif; ?>
					<?php if ( !empty($dentalpress_post_format_settings['video']['ogg']) ) : ?>
						<source src="<?php echo esc_url($dentalpress_post_format_settings['video']['ogg']); ?>" type="video/ogg">
					<?php endif; ?>
					<?php esc_html_e('Your browser does not support the video tag.', 'dentalpress'); ?>
				</video>
	...
	<div class="vu_bp-content-wrapper">
		<header class="vu_bp-header">
			...
			<div class="vu_bp-meta">
				...
				<?php if ( !empty($dentalpress_post_format_settings['video']['embed-code']) or !empty($dentalpress_post_format_settings['video']['m4v']) or !empty($dentalpress_post_format_settings['video']['ogg']) ) : ?>
